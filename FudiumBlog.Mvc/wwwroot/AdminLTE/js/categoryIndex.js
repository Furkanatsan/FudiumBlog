$(document).ready(function () {
                                ...
                                $.each(categoryListDto.Categories.$values, function (index, category) {
                                    tableBody += `
                                                <tr name=${category.Id}>
                                                    ...
                                                    <button class="btn btn-danger btn-sm btn-delete btn-block" data-id="${category.Id}"><span class="fas fa-minus-circle"></span> Sil</button>
                                                    </td>
                                               </tr>`;
                                });
    ...
    $(function () {
        ...
        //Ajax get
        //Ajax post kategori ekleme kaydetme
                        ...
                        `
                                ...
                                <td>
                                 ...
                                 <td>
                                   ...
                                   <button class="btn btn-danger btn-sm btn-delete btn-block" data-id="${categoryAddAjaxModel.CategoryDto.Category.Id}"><span class="fas fa-minus-circle"></span> Sil</button>
                                 </td>
    ...
    $(document).on('click', '.btn-delete', function (event) {
        ...
        const categoryName = tableRow.find('td:eq(1)').text();//2.sıradaki td nin ismini çektik.
        Swal.fire({
            title: 'Emin Misiniz?',
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (categoryDto.ResultStatus === 0) {
                            Swal.fire(
                                'Silindi!',
                                `${categoryDto.Category.Name} kategorisi silinmiştir.`,
                                'success'
                            );
                        ...
                        <tr name="${categoryUpdateAjaxModel.CategoryDto.Category.Id}">
                                ...
                                <td>
                                 ...
                                 <td>
                                   ...
                                   <button class="btn btn-danger btn-sm btn-delete btn-block" data-id="${categoryUpdateAjaxModel.CategoryDto.Category.Id}"><span class="fas fa-minus-circle"></span> Sil</button>
                                 </td>
